...
app.post("/api/marketing/generate", async (req, res) => {
  try {
    const { topic, persona, mode = 'full', currentData, strategy = 'educacional' } = req.body;
    ...
    if (mode !== 'strategies') {
      ...
      else if (strategy === 'alerta') strategyDesc = "Abordagem de Alerta/Urgência: Destaque prazos, riscos de perda de direitos ou erros comuns que as pessoas cometem. Crie um senso de atenção (sem ser sensacionalista).";
