        ...
        <div className="p-8">
            {activeTab === 'info' ? (
                        ...
                        <div key={field.name} className={spanClass}>
                            ...
                            {field.type === 'select' ? (
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 outline-none transition text-sm"
                                >
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 border rounded-xl outline-none transition text-sm
                                        ${field.readOnly 
                                            ? 'bg-cream-50 dark:bg-bordeaux-900/40/50 text-slate-500 cursor-not-allowed border-slate-200 dark:border-gold-500/15' 
                                            : 'bg-white dark:bg-bordeaux-950/40 text-slate-900 dark:text-white border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500'
                                        }`}
                                />
                            )}
                        </div>
                ...
                <div className="md:col-span-6 mt-2 space-y-4">
                    ...
                    {formData.isReferral && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border border-slate-200 dark:border-gold-500/15 rounded-xl bg-cream-50 dark:bg-bordeaux-900/40/50">
                            <div>
                                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide mb-1.5">
                                    Nome do Indicador
                                </label>
                ...
                <div className="md:col-span-6 flex justify-end gap-3 mt-8 pt-4 border-t border-slate-100 dark:border-gold-500/20">
                    ...
                    type="button"
                    onClick={onClose}
                    className="px-5 py-2.5 text-slate-600 dark:text-slate-300 font-medium bg-white dark:bg-bordeaux-950/40 border border-slate-200 dark:border-gold-500/15 hover:bg-slate-50 dark:hover:bg-bordeaux-900/60 rounded-xl transition shadow-sm"
                    >
                    Cancelar
                    </button>
                    <button
                ...
                <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                            {formData.documents?.some(d => d.type === 'application/pdf') && (
                                <button 
                                    ...
                                    className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-4 py-2 rounded-lg text-sm font-bold border border-slate-200 dark:border-gold-500/15 hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 transition"
                                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-2">
                        <button onClick={() => generatePDF('procuracao')} className="flex items-center justify-center gap-2 p-3 bg-slate-100 dark:bg-slate-800 rounded-xl hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 transition text-xs font-bold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-gold-500/15">
                            <DocumentTextIcon className="h-5 w-5 text-primary-600" />
                            Gerar Procuração
                        </button>
                        <button onClick={() => generatePDF('hipossuficiencia')} className="flex items-center justify-center gap-2 p-3 bg-slate-100 dark:bg-slate-800 rounded-xl hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 transition text-xs font-bold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-gold-500/15">
                            <ScaleIcon className="h-5 w-5 text-purple-500" />
                            Gerar Declaração
                        </button>
                        <button onClick={() => generatePDF('renuncia')} className="flex items-center justify-center gap-2 p-3 bg-slate-100 dark:bg-slate-800 rounded-xl hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 transition text-xs font-bold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-gold-500/15">
                    ...
                    <div className="space-y-3">
                        {formData.documents && formData.documents.length > 0 ? (
                            formData.documents.map((doc, idx) => (
                                <div key={doc.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-cream-50 dark:bg-bordeaux-900/40 border border-slate-200 dark:border-gold-500/15 rounded-xl gap-3">
                                    ...
                                    <div className="flex items-center gap-2 sm:ml-auto">
                                        ...
                                        <div className="relative">
                                            ...
                                            {activeTagMenu === doc.id && (
                                                <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-bordeaux-950/40 border border-slate-200 dark:border-gold-500/15 rounded-xl shadow-lg z-10 p-2">
                    ...
                    <div className="space-y-3">
                        {formData.petitions && formData.petitions.length > 0 ? (
                            formData.petitions.map((petition, idx) => (
                                <div key={idx} className="flex items-center justify-between p-3 bg-cream-50 dark:bg-bordeaux-900/40 border border-slate-200 dark:border-gold-500/15 rounded-xl">
                                    <div className="flex items-center gap-3">
