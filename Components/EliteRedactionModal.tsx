          ...
          >
            ...
            <div className="flex justify-between items-start relative z-10">
              <div>
                ...
                <p className="text-xs text-emerald-700/80 dark:text-emerald-400/80 mt-1">Modelo mais recente do Google — padrão atual de alta confiabilidade e estabilidade para peças jurídicas.</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">Modelo alternativo estável — use se o padrão estiver instável.</p>
              </div>
            </div>
          </button>
