  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white dark:bg-bordeaux-950/60 rounded-2xl shadow-2xl w-full max-w-lg border border-slate-200 dark:border-gold-500/20 flex flex-col max-h-[85vh]">
                  ...
                  <div 
                    ...
                    className={`p-4 rounded-xl border transition-all ${
                      isOverdue 
                        ...
                        : 'bg-cream-50 dark:bg-bordeaux-900/40 border-slate-100 dark:border-gold-500/15'
                    }`}
                  >
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-slate-200 dark:border-gold-500/15/50">
                      ...
                      {onEditEvent && (
                        <button
                          ...
                          className="flex-1 py-2 text-xs font-bold uppercase tracking-wider bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 transition-colors"
                        >
                          Editar
                        </button>
                      )}
        ...
        {totalPages > 1 && (
          <div className="p-4 border-t border-slate-200 dark:border-gold-500/20 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50 rounded-b-2xl">
            <button 
