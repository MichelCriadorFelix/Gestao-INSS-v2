            ...
            <div className="bg-white dark:bg-bordeaux-950/60 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-slate-200 dark:border-gold-500/20 flex flex-col">
                <div className="flex justify-between items-center p-6 border-b border-slate-100 dark:border-gold-500/20 bg-white dark:bg-bordeaux-950/60 sticky top-0 z-10">
                    <div className="flex items-center gap-3">
                         ...
                         <h3 className="text-xl font-serif font-semibold text-slate-900 dark:text-cream-50">
                ...
                <form onSubmit={handleSubmit} className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                     ...
                     <div className="md:col-span-2">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            <button
                                ...
                                className="w-full flex items-center justify-between px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white text-left"
                            >
                                        ...
                                        <div className="p-3 border-b border-slate-100 dark:border-gold-500/20 bg-white dark:bg-bordeaux-950/60 sticky top-[56px] z-20">
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-9 pr-3 py-2.5 bg-cream-50 dark:bg-bordeaux-900/40 border border-slate-200 dark:border-gold-500/15 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 dark:text-white"
                                                    autoFocus
                                                />
                                            </div>
                                        </div>
                     ...
                     <div>
                        ...
                        <input type="text" name="firstName" required value={formData.firstName || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white" />
                     </div>
                     <div>
                        <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1.5">Sobrenome</label>
                        <input type="text" name="lastName" value={formData.lastName || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white" />
                     </div>
                     <div>
                        <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1.5">CPF</label>
                        <input type="text" name="cpf" value={formData.cpf || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white" />
                     </div>
                     <div>
                        ...
                        <input type="text" name="serviceType" required value={formData.serviceType || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white" />
                     </div>
                     ...
                     <div>
                         ...
                         <select name="lawyer" required value={formData.lawyer || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white">
                     ...
                     <div>
                         ...
                         <select name="lawyerSplit" value={formData.lawyerSplit ?? 60} onChange={(e) => setFormData(prev => ({...prev, lawyerSplit: Number(e.target.value)}))} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white">
                     ...
                     <div>
                         ...
                         <input type="number" name="totalFee" value={formData.totalFee || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white font-mono" placeholder="0.00" />
                     </div>
                     ...
                     <div>
                         ...
                         <select name="status" value={formData.status || 'Pendente'} onChange={(e) => {
                             ...
                             setFormData(update);
                         }} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white">
                     ...
                     <div>
                         ...
                         <input type="date" name="concludedAt" value={formData.concludedAt || ''} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white" />
                     </div>
                     )}
                     <div>
                         <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1.5">Forma de Pagamento</label>
                         <select name="paymentMethod" value={formData.paymentMethod || 'Parcelado'} onChange={handleChange} className="w-full px-4 py-2.5 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none dark:text-white">
                             ...
                             <div className="flex items-center justify-between gap-4 mb-4">
                                 <div>
                                     ...
                                     <select
                                         ...
                                         className="w-32 px-4 py-2 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-lg outline-none text-sm dark:text-white"
                                     >
                             ...
                             <div className="flex items-end gap-3">
                                 <div className="flex-1">
                                     ...
                                     <input
                                         ...
                                         className="w-full px-3 py-2 bg-white dark:bg-bordeaux-950/40 border border-slate-300 dark:border-gold-500/15 rounded-lg text-sm dark:text-white outline-none focus:ring-2 focus:ring-indigo-500"
                                     />
                                 </div>
                                 <button
                                     type="button"
                     ...
                     <div className="md:col-span-2 bg-cream-50 dark:bg-bordeaux-900/40/50 p-6 rounded-2xl border border-slate-200 dark:border-gold-500/15 mt-2">
                     ...
                     <div className="md:col-span-2 flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-gold-500/20">
                        <button type="button" onClick={onClose} className="px-5 py-2.5 text-slate-600 dark:text-slate-300 font-medium bg-white dark:bg-bordeaux-950/40 border border-slate-200 dark:border-gold-500/15 hover:bg-slate-50 rounded-xl transition">Cancelar</button>
