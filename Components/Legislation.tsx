...
const Legislation: React.FC<LegislationProps> = ({ customLaws, onSaveCustomLaws }) => {
  ...
  if (selectedLaw) {
    return (
      <div className="flex flex-col h-[calc(100vh-120px)] bg-white dark:bg-bordeaux-950/40 rounded-2xl shadow-sm border border-slate-200 dark:border-gold-500/15 overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-gold-500/15 bg-cream-50 dark:bg-bordeaux-900/40/50">
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-bordeaux-950/40 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-gold-500/15">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-full border border-slate-200 dark:border-gold-500/15 bg-cream-50 dark:bg-bordeaux-950/60 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-primary-500 outline-none transition-all"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <select
            className="px-4 py-2 border border-slate-200 dark:border-gold-500/15 bg-cream-50 dark:bg-bordeaux-950/60 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-primary-500 outline-none transition-all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredLaws.map((law) => (
            <div
              ...
              className="text-left block p-5 rounded-xl border border-slate-200 dark:border-gold-500/15 bg-cream-50 dark:bg-bordeaux-900/40/50 hover:bg-slate-100 dark:hover:bg-bordeaux-900/50 transition-colors group cursor-pointer"
            >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-bordeaux-950/40 rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleAddLaw} className="p-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-gold-500/15 rounded-lg bg-cream-50 dark:bg-bordeaux-950/60 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-gold-500/15 rounded-lg bg-cream-50 dark:bg-bordeaux-950/60 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none resize-none h-24"
