            ...
            <div className="bg-white dark:bg-bordeaux-950/60 rounded-2xl shadow-2xl w-full max-w-md border border-slate-200 dark:border-gold-500/20 p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-gold-500/20">
                        ...
                        <input type="text" value={url} onChange={e => setUrl(e.target.value)} disabled={isEnvManaged} className="w-full px-4 py-2 bg-slate-50 dark:bg-bordeaux-900/40 border border-slate-200 dark:border-gold-500/15 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed font-mono text-slate-600 dark:text-slate-300" placeholder="https://xyz.supabase.co" />
                    </div>
                    <div>
                        <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Supabase Anon Key</label>
                        <div className="relative">
                            <input type="password" value={key} onChange={e => setKey(e.target.value)} disabled={isEnvManaged} className="w-full px-4 py-2 bg-slate-50 dark:bg-bordeaux-900/40 border border-slate-200 dark:border-gold-500/15 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed font-mono text-slate-600 dark:text-slate-300" placeholder="eyJhbGciOiJIUzI1NiIsInR5..." />
                            <button 
                ...
                <div className="mt-6 pt-6 border-t border-slate-100 dark:border-gold-500/20 space-y-3">
                    ...
                    <button onClick={handleRestore} className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 dark:bg-bordeaux-900/40 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-bordeaux-900/60 rounded-lg text-sm font-medium transition">
                ...
                <div className="flex gap-3 mt-6">
                    ...
                    <div className="flex-1 flex justify-end gap-2">
                        ...
                        {!isEnvManaged && <button onClick={handleSave} className="px-4 py-2 fc-btn-primary text-cream-50 rounded-lg text-sm font-bold shadow-lg shadow-primary-500/30 transition">Salvar & Conectar</button>}
                    </div>
                </div>
            </div>
        </div>
